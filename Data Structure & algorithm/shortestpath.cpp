...
void chhota_rasta(map<int,list<int>>g, int s, int d)
{
    ...
    cout<<"Source and destination is not connected";
    return;
}
...
int main()
{
    ...
    //Undirected graph test successfull
    graph[0] = {1,3};
    graph[1] = {0,2};
    graph[2] = {0,1};
    graph[3] = {0,4,7};
    ...
    //Directed graph test successfull
    // graph[0] = {1,3};
    // graph[1] = {0,2};
    // graph[2] = {3,4};
    // graph[3] = {7,5};
